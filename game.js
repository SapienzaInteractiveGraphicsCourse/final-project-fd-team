   ...
   var camera = new BABYLON.FollowCamera("FollowCam", new BABYLON.Vector3(-40, 10, 0), scene);
    ...
    if ((map["w"] || map["W"])) {
        ...
        lightb.material=luce;
            ...
            groundMat.diffuseTexture = new BABYLON.Texture("textures/sampie.jpg", scene);
            groundMat.diffuseTexture.uScale = 30;
            groundMat.diffuseTexture.vScale = 30;
            groundMat.specularTexture = new BABYLON.Texture("textures/sampie.jpg", scene);
...
var createGUI = function(scene, showScene) {
    ...
    switch (showScene) {
        case 0:
            ...
            var imagemenu1 = new BABYLON.GUI.Image("imagemenu1", "textures/lightBlueSkyBox/lightBlueSky_NZ.jpg");
        ...
        case 3:
                ...
                var imagemenu3 = new BABYLON.GUI.Image("imagemenu3", "textures/about.png");
